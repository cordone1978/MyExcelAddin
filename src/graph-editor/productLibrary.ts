    ...
    components: [
      {
        ...
        ports: [
          { id: "cyclone_in", name: "进风口", x: 94, y: 50, direction: "in" },
          { id: "cyclone_out", name: "下料口", x: 60, y: 182, direction: "out" },
        ],
        parameters: { 材质: "碳钢喷涂", 规格: "CF-900", 分离效率: "95%" },
        hotspots: [{ id: "hs6", label: "检修仓", x: 56, y: 30 }],
      },
    ],
  },
];
